...
class friUdp{
 public:
  friUdp(int port=FRI_DEFAULT_SERVER_PORT, const char *remoteHost = NULL,const char *localHost=NULL);
 ...
 protected:
  ...
  /// incoming packages
  void Init(const char * remoteHost=NULL,const char *localHost=NULL);
  void Close(void);
#ifdef WIN32
