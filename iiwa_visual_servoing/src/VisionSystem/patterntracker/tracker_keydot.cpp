...
////	{
////		cv::Scalar color = cv::Scalar(0, 0, rng.uniform(100, 255)); //R
////		dot_colors.push_back(color);
////	}
////	for (int i = 0; i < pattern_size.width; i++)
////	{
////		cv::Scalar color = cv::Scalar(0, rng.uniform(100, 255), 0); //G
////		dot_colors.push_back(color);
////	}
////	for (int i = 0; i < pattern_size.width; i++)
////	{
////		cv::Scalar color = cv::Scalar(0, rng.uniform(100, 255), rng.uniform(100, 255)); //Yellow
////		dot_colors.push_back(color);
////	}
////	for (int i = 0; i < pattern_size.width; i++)
////	{
////		cv::Scalar color = cv::Scalar(rng.uniform(100, 255), 0, 0); //Blue
////		dot_colors.push_back(color);
////	}
////	for (int i = 0; i < pattern_size.width; i++)
////	{
////		cv::Scalar color = cv::Scalar(rng.uniform(100, 255), 0, rng.uniform(100, 255)); //Purple
////		dot_colors.push_back(color);
////	}
////	for (int i = 0; i < pattern_size.width; i++)
////	{
////		cv::Scalar color = cv::Scalar(rng.uniform(100, 255), rng.uniform(100, 255),0); //unknow color
////		dot_colors.push_back(color);
////	}
////	for (int i = 0; i < pattern_size.width; i++)
////	{
