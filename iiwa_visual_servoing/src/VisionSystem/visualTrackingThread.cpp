...
void VisualTrackingThread::run()
{
    ...
    hardimageL = imread("./Data/left.jpg", CV_LOAD_IMAGE_COLOR);
    hardimageR = imread("./Data/right.jpg", CV_LOAD_IMAGE_COLOR);
//    hardimageL = imread("./Data/left_2017-08-08-13-44-01-1_raw.png", CV_LOAD_IMAGE_COLOR);
//    hardimageR = imread("./Data/right_2017-08-08-13-44-01-1_raw.png", CV_LOAD_IMAGE_COLOR);
//    hardimageL = imread("./Data/left_2017-08-02-15-25-47-1_raw.png", CV_LOAD_IMAGE_COLOR);
//    hardimageR = imread("./Data/right_2017-08-02-15-25-47-1_raw.png", CV_LOAD_IMAGE_COLOR);
...
//                Mat Eng_L_, Eng_R_;
//                string ename_l = "eng_l.png";
//                string ename_r = "eng_r.png";
//                imwrite(ename_l.c_str(), needleEnergyL_mat);
//                imwrite(ename_r.c_str(), needleEnergyR_mat);
//                Eng_L_ = imread(ename_l, CV_LOAD_IMAGE_COLOR);
//                Eng_R_ = imread(ename_r, CV_LOAD_IMAGE_COLOR);
//                Eng_L_.copyTo(needleEnergies_show.frameLeft);
//                Eng_R_.copyTo(needleEnergies_show.frameRight);
//                emit checkImages(needleEnergies_show);
//            }
//        }
