...
#endif //USING_VNL
/*****************************************************************************/
void Frame::getRotationAngles(double angles[3], bool &isGimbalLock) const
{
	...
	if(fabs(angles[1] - Frame::HALF_PI) > Frame::SMALL_ANGLE &&
	  ...
	  angles[2] = atan2(this->rotation[1][0]/cy, 
		...
		isGimbalLock = true;
	    angles[2] = 0;
	    angles[0] =  atan2(this->rotation[0][1],this->rotation[1][1]);
	}
}
/*****************************************************************************/
...
{
	double thisRotationAngles[3], thisTranslation[3], otherRotationAngles[3], otherTranslation[3];
	bool isGimbalLock;
