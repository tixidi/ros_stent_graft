...
friRemote::friRemote(int port,const char *hintToRemoteHost,const char *hinToLocalHost):remote(port,hintToRemoteHost,hinToLocalHost)
{
...
int friRemote::doDataExchange()
{
  ...
  int friRemote::doPositionControl(double newJntPosition[LBR_MNJ], bool flagDataExchange)
 ...
 */
int friRemote::doJntImpedanceControl(const double newJntPosition[LBR_MNJ],
                                        const double newJntStiff[LBR_MNJ],
                                        const double newJntDamp[LBR_MNJ],
                                        const double newJntAddTorque[LBR_MNJ],
...
int friRemote::doCartesianImpedanceControl(const double newCartPosition[FRI_CART_FRM_DIM],
                                           const double newCartStiff[FRI_CART_VEC],
                                           const double newCartDamp[FRI_CART_VEC],
                                           const double newAddTcpFT[FRI_CART_VEC],
                                           const double newJntNullspace[LBR_MNJ],
                                           bool flagDataExchange)
{
